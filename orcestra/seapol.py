...
map2 = xr.open_dataset('/Users/m219063/work/data/orcestra/gridded_composite_20240903_1500.nc',engine='netcdf4').DBZ[0,:,:]
# %%
# Make plot
...
seapol_west = axs[0].pcolormesh(map1.longitude[ix,iy], map1.latitude[ix,iy], map1[ix,iy], cmap=discrete_mask_cmap, vmin=-10, vmax=60,shading='auto')
...
seapol_east = axs[1].pcolormesh(map2.longitude[ix,iy], map2.latitude[ix,iy], map2[ix,iy], cmap=discrete_mask_cmap, vmin=-10, vmax=60, shading='auto')
